...
document.getElementById("sketchToBeDrawn").innerHTML = "Sketch to be drawn: " + random_sketch;
...
function check_sketch(){
    ...
    document.getElementById('timerLabel').innerHTML = "Timer: " + timer_counter;
...
function updateCanvas(){
    ...
    window.sketch = quick_draw_data_set[rand_no];
